<x-app-layout>
    ...
    <section id="create-post-section" class="flex">
        <x-create-post />
    </section>
    ...
    <section>
        <div class='row d-flex justify-content-center mx-4'>
            <div class='fw-bold col-3'>
                ...
                <input type='image' src="{{ asset('/assets/create-button.svg') }}" class='btn-primary mb-1 ms-auto' onclick="createPost()" />
            </div>
            <div class="col-4">
...
<script>
    function createPost() {
        var createPost = document.getElementById('create-post-section');
